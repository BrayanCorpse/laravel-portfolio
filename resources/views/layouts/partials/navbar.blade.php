<div class="oop"></div>
    <nav class="navbar-main">
        ...
        <div class="navbar-modal">
            <div class="navbar-modal-close gft-font">
            ...
            <div class="navbar-modal-body">
                ...
                <div class="search-col">
                    <form>
                        <div class="fm-group mt-20">
                            <button class="search-addon-btn" type="submit">Search</button>
                            <input type="search" class="search-control" placeholder="Search Site">
                        </div>
                    </form>
                </div>
            </div>
